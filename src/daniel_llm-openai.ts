...
export class danielDemoLlmClient {
  ...
  BeginMessage(ws: WebSocket, firstname: string, email: string) {
    beginSentence =
      `If user begins with "Hi", this is ${firstname}, (proceed to step1) If user begins with “Hi”, “hello”, or company greeting, say: “hi, ${firstname} (proceed to step 1)`;
