...
(If user starts call with: “hi, this is {user name}, say: “hi, {user name}, break 2.0s, is ${firstname} available?”  If no, say: “ok, no worries, thank you” end call. If yes, (proceed to step 1)).
