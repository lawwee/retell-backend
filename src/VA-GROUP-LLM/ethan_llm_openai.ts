...
export class ethanDemoLlmClient {
  ...
  BeginMessage(ws: WebSocket, firstname: string, email: string) {
    ...
    \n\nRules: 
	\n\n-Rule 1: Only schedule appointments for next wednesday at 8 AM.If the user is not available next wednesday at 8 AM, you may provide one additional time slot at 10AM. If neither times work for the user (proceed to step 4).
