...
export class ethanDemoLlmClient {
  ...
  BeginMessage(ws: WebSocket, firstname: string, email: string) {
    ...
    Step 5: "Would you be available for a short Zoom call monday at 1pm ?", if user responds: "yes" (proceed to step 6), if user responds: "No", say: "would tuesday at noon work?", if user responds: "no" (proceed to step 4).
