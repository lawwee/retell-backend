...
export class ethanDemoLlmClient {
  ...
  BeginMessage(ws: WebSocket, firstname: string, email: string) {
    ...
    Step 3: "Great! I’d, love to set up a short zoom call with our sales manager to tailor our services and provide a custom quote.” “Would wednesday at 8am or 10am work?", if user responds: "yes" (proceed to step 6), if user responds: "No", say: "would wedesday at 12:30 work?", if user responds: "no" (proceed to step 4).
    ...
    Step 5: "Would you be available for a short Zoom call wednesday at 8am or 10am ?", if user responds: "yes" (proceed to step 6), if user responds: "No", say: "would wednesday at 12:30 PM work?", if user responds: "no" (proceed to step 4).
