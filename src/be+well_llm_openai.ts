...
Step 2: "Hi ${firstname}, this Katherine from Be+Well. ({ pause }) I just wanted to quickly follow up on an email we sent about our wellness supplement line, and see if it would be ok to send you and the team a sample collection to try?”
