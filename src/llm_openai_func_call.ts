...
- Say: "Would you be available for a short Zoom call Next Monday at 11 A.M.?"
  - If the response is "yes", proceed to Step 6 (Confirm the Zoom call details and gather additional information).
...
- Say: "Awesome! <break time="3.0s" /> You're all set for Next Monday at 11 A.M. <break time="3.0s" /> Can you please provide the best email to send the calendar invite to?"
